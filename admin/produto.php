                    ...
                    <div class="cadastro-categoria">
                        ...
                        <div class="hr-title"> <br></div>
                            <div class="form-deashboard">
                                ...
                                <input type="number" class="campo-txt" placeholder="Preço" name="txtPreco" maxlength="5"value="<?=$preco?>"/>
                                <input type="number" class="campo-txt" placeholder="Desconto" name="txtDesconto" maxlength="5" value="<?=$desconto?>"/>
